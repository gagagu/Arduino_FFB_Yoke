...
void CMD_READ_ALL_VALUES() {
  ...
  SerialWriteValue(ROLL_AxisConfiguration.iMin);                              // 32
  SerialWriteValue(ROLL_AxisConfiguration.iMax);                              // 33
  SerialWriteValue(counterRoll.read());                         // 34
  SerialWriteValue(roll_speed);                                 // 35
  SerialWriteValue(forces[MEM_ROLL]);                           // 36

  SerialWriteValue(PITCH_AxisConfiguration.iMin);                              // 37
  SerialWriteValue(PITCH_AxisConfiguration.iMax);                              // 38
